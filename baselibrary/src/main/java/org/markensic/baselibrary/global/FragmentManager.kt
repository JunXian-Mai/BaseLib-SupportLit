...
object FragmentManager: FragmentLifecycle() {
    ...
    override fun onFragmentResumed(fm: android.support.v4.app.FragmentManager, f: Fragment) {
    ...
    fun addOrHideFragment(fm: android.support.v4.app.FragmentManager, tabLayout: TabLayout, containerLayoutId: Int, toIndex: Int) {
    ...
    fun addOrHideFragment(tabLayout: TabLayout, toIndex: Int, transaction: (from: Fragment, to: Fragment) -> Unit) {
        val toFragment = tabLayout.fragments[toIndex]
        val fromFragment = tabLayout.fragments[tabLayout.selectedIndex]
